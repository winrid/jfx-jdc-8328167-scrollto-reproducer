...
public class VirtualFlow<T extends IndexedCell> extends Region {
    ...
    // Set to true to enable the fix for scrollTo() not ensuring full visibility.
    // See: https://bugs.openjdk.org/browse/JDK-8328167
    public static boolean ENABLE_SCROLLTO_VISIBILITY_FIX = false;
...
//                cell.updateIndex(-1);
        ...
        if (ENABLE_SCROLLTO_VISIBILITY_FIX && pendingScrollToIndex >= 0) {
    ...
    public void scrollToTop(int index) {
        ...
        if (ENABLE_SCROLLTO_VISIBILITY_FIX) {
